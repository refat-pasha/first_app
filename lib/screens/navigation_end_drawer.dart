...
import 'body_row_column.dart';

void main(List<String> args) {}

class navigation_end_drawer extends StatelessWidget {
  const navigation_end_drawer({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Things to learn(navigation end drawer)"),
        titleSpacing: 10,
        centerTitle: false,
        toolbarHeight: 60,
        toolbarOpacity: 1,
